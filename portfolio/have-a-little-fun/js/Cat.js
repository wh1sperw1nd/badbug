...
function Cat(){
  ...
  this.scarf1.material.sideCat = THREE.DoubleSide;
...
Cat.prototype.prepareAttack = function(sideCat, v){
  
  var angles = this.getAngles(v, this.rightShoulder.position, this.armHeight);
  this.updateArm(sideCat, angles, 1, Back.easeOut, null);
}

Cat.prototype.attack = function(sideCat, v, direction){
  var _this = this;
  var shoulder = (sideCat == "right")? this.rightShoulder : this.leftShoulder;
  var angles = this.getAngles(v, shoulder.position, this.armHeight);
  this.updateArm(sideCat, angles, .15, Back.easeOut, function (){
...
Cat.prototype.replaceFoot = function(sideCat){
  var _this = this;
  var angles =  {theta:0, alpha:0, beta:0};
  this.updateArm(sideCat, angles, 2, Strong.easeInOut, function (){
...
Cat.prototype.updateArm = function(sideCat, angles, speed, ease, callBack){
...
Cat.prototype.getAngles = function(targetPos, shoulderPos, segmentLength){
