...
function onReady() {
    ...
    renderer = new PIXI.WebGLRenderer(800, 600, {backgroundColor: 0x000000});
...
//    container = new PIXI.ParticleContainer(200000, [false, true, false, false, false]);
    ...
    bunny1 = new PIXI.Texture(wabbitTexture.baseTexture, new PIXI.Rectangle(2, 6, 88, 145));

    bunnyTextures = [bunny1];
    bunnyType = 0;
