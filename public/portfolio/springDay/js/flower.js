$(document).ready(function () {
    ...
    var listLaunchSound = [
        "./media/Snap_Rhythm_is_A_Dancer",
        "./media/Cheb_Khaled_Aicha",
        "./media/Imany_dont_be_so_shy",
        "./media/The_White_Stripes_Seven_Nation_Army",
    ]
    ...
    function playAlone(src) {
        var audio = new Howl({
            src: [listLaunchSound[src]+ ".mp3", listLaunchSound[src]+ ".ogg"],
            autoplay: false,
            loop: false,
            volume: 0.5,
            html5: true
    ...
    var playSound = function(song) {
        //var s = null;
        //var sound = new Howl({
        //    src: [listLaunchSound[song]],
        //    autoplay: false,
        //    preload: true,
        //    loop: false,
        //    volume: 1
    ...
    tlCrazy
        ...
        .to(head, 0.3, {y: 60}, "one").to(face, 0.3, {y: 3}, "one").to(leaf_group_1, 0.3, {y: 20}, "one")
        .to(leaf_group_2, 0.3, {y: 45}, "one").to(leaf_group_3, 0.3, {y: 45}, "one")
        .to(leaf_group_4, 0.3, {y: 20}, "one").to(stem_1,0.3,{scaleY: 1, rotation: -15, transformOrigin: "center bottom"},"two")
        .to(head,0.3,{y: 5, x: -40, rotation: -15, transformOrigin: "center bottom"},"two")
        .to(face, 0.3, {x: -2, y: -3}, "two").to(leaf_group_1,0.3,{y: 0, x: -7, rotation: -15, transformOrigin: "right bottom"},"two")
        .to(leaf_group_2,0.3,{y: 10, x: -22, rotation: -15, transformOrigin: "right bottom"},"two")
        .to(leaf_group_3,0.3,{y: 10, x: -24, rotation: -15, transformOrigin: "left bottom"},"two")
        .to(leaf_group_4,0.3,{y: 0, x: -7, rotation: -15, transformOrigin: "left bottom"},"two")
        .to(stem_1,0.3,{scaleY: 0.65, rotation: 0, transformOrigin: "center bottom"},"three")
        .to(head,0.3,{y: 60, x: 0, rotation: 0, transformOrigin: "center bottom"},"three")
        .to(face, 0.3, {x: 0, y: 3}, "three")
        .to(leaf_group_1,0.3,{y: 20, x: 0, rotation: 0, transformOrigin: "right bottom"},"three")
        .to(leaf_group_2,0.3,{y: 45, x: 0, rotation: 0, transformOrigin: "right bottom"},"three")
        .to(leaf_group_3,0.3,{y: 45, x: 0, rotation: 0, transformOrigin: "left bottom"},"three")
        .to(leaf_group_4,0.3,{y: 20, x: 0, rotation: 0, transformOrigin: "left bottom"},"three")
        .to(stem_1,0.3,{scaleY: 1, rotation: 15, transformOrigin: "center bottom"},"four")
        .to(
            head,
            0.3,
    ...
    tlCool
        .to(head, 0.23, {x: 8, repeat: -1, yoyo: true}, "two")
        .to(
            leaf_group_1,
            0.1,
    ...
    tlSexy.timeScale(0.8);

    var getCurrentSlot, rotate, tick;

    rotate = function ($elm, deg) {
    ...
    getCurrentSlot = function (slotType) {
        switch (slotType) {
            case "m":
    ...
    tick = function ($elm, slotCount, calcType) {
        rotate($elm, ((getCurrentSlot(calcType) / slotCount) * 360) - 180);
        setInterval(function () {
            return rotate($elm, ((getCurrentSlot(calcType) / slotCount) * 360) - 180);
        }, 1000);
    };

    tick($(".hand-minutes")[0], 60, "m");

    tick($(".hand-hours")[0], 12, "h");
});